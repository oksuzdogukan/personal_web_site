...
function AboutMe() {
  ...
  return (
    <section className={`hero-section ${visible ? 'visible' : ''}`} id="about" ref={sectionRef}>
      {/* Floating orbs */}
      ...
      <div className="hero-container">
        ...
        <div className="hero-content">
          ...
          <p className="hero-description">
            Software Engineering student building modern, performant web applications
            with React. Always shipping side projects, always leveling up.
          </p>
        ...
        <div className="hero-image-wrapper">
          ...
          <div className="image-frame">
            <img src={dogukanImg} alt="Doğukan Öksüz — Frontend Developer" className="hero-image" />
          </div>
